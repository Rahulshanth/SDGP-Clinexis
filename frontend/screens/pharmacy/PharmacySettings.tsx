...
const styles = StyleSheet.create({
  ...
  sectionHeader: { fontSize: 14, fontWeight: '800', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1, paddingHorizontal: 24, marginTop: 24, marginBottom: 12 },
  sectionCard: { backgroundColor: '#ffffff', marginHorizontal: 20, borderRadius: 20, paddingVertical: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.03, shadowRadius: 10, elevation: 2, borderWidth: 1, borderColor: '#f1f5f9' },
  settingItem: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 },
  iconBg: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  settingTitle: { flex: 1, fontSize: 15, fontWeight: '600', color: '#1e293b' },
  settingValue: { fontSize: 14, color: '#64748b', fontWeight: '500' },
  deleteAccount: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 40, gap: 8 },
  deleteText: { fontSize: 15, fontWeight: '700', color: '#ef4444' },
  versionText: { textAlign: 'center', fontSize: 12, color: '#94a3b8', marginTop: 20, fontWeight: '600' },
});