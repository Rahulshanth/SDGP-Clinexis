...
const ORDERS_DATA = [
  {
    ...
    time: '10:30 AM',
    status: 'NEW',
    image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=200&auto=format&fit=crop',
    statusColor: '#3b82f6',
    statusBg: '#eff6ff',
  },
  {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.actionRow}>
        ...
        <TouchableOpacity style={styles.secondaryActionButton}>
          <Ionicons
            name={order.isDigital || order.status === 'PROCESSING' ? 'chatbubble-outline' : 'eye-outline'}
            size={20}
            color="#64748b"
          />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#ffffff', borderRadius: 20, padding: 15, marginBottom: 15, borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.02, shadowRadius: 8, elevation: 2 },
  cardHeader: { flexDirection: 'row', gap: 15, marginBottom: 15 },
  imageContainer: { position: 'relative' },
  orderImage: { width: 80, height: 80, borderRadius: 12, backgroundColor: '#f1f5f9' },
  statusIconBg: { width: 80, height: 80, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  newIndicator: { position: 'absolute', top: -5, right: -5, width: 15, height: 15, borderRadius: 7.5, backgroundColor: '#3b82f6', borderWidth: 2, borderColor: '#ffffff' },
  orderInfo: { flex: 1, justifyContent: 'center' },
  nameRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  patientName: { fontSize: 18, fontWeight: '700', color: '#1e293b' },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  statusText: { fontSize: 10, fontWeight: '800' },
  orderType: { fontSize: 14, color: '#64748b', fontWeight: '500', marginBottom: 8 },
  ...
  readyButton: { backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e2e8f0' },
  actionButtonText: { fontSize: 16, fontWeight: '700', color: '#ffffff' },
  readyButtonText: { color: '#1e293b' },
  secondaryActionButton: { width: 48, height: 48, borderRadius: 12, borderWidth: 1, borderColor: '#e2e8f0', justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffffff' },
});